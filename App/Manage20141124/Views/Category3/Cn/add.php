<script src="<?php echo JS_PUBLIC_PATH ?>My97DatePicker/WdatePicker.js"
type="text/javascript"></script>
<script src="<?php echo JS_MODULE_PATH ?>command.js"
type="text/javascript"></script>
<script src="<?php echo JS_MODULE_PATH ?>Category3.js"
type="text/javascript"></script>
<form method="POST" action="add_save" name="myform"
    ...
    <table width="500" border="1">
        <tr>
            ...
            <td width="337"><select name="category_1" id="category_1"
                                    onchange="setCategory_1()">
                    <option value=""></option>
                    <?php
            ...
            <td><select name="category_2" id="category_2" onchange="setOrders()">
                    ...
                    if (!empty($category_2)) {
                        foreach ($category_2 as $key => $value) {
                            if ($key == get_post_value('category_2')) {
                                echo '<option value="' . $key . '" selected="selected">' . $value . '</option>';
                            } else {
                                echo '<option value="' . $key . '">' . $value . '</option>';
                            }
                    ...
                    ?>
                </select> <span id="msg_category_2" style="display: none">请选择二级类目(中文)</span></td>
        </tr>
        <tr>
            <td width="147">序号</td>
        ...
        <tr>
            <td>三级类目(中文)</td>
            <td><input type="text" name="category_3_cn" id="category_3_cn"
                       value="" maxlength="50"> <span id="msg_category_3_cn"
                       style="display: none">请输入三级类目(中文)</span></td>
        </tr>
        <tr>
            <td>三级类目(泰文)</td>
            <td><input type="text" name="category_3_th" id="category_3_th"
                       value="" maxlength="50"> <span id="msg_category_3_th"
                       style="display: none">请输入三级类目(泰文)</span></td>
        </tr>
        <tr>
            <td>链接地址</td>
            <td><input type="text" name="category_3_url" id="category_3_url"
                       value="" maxlength="50"> <span id="msg_category_3_url"
                       style="display: none">请输入正确的链接地址</span></td>
        </tr>
        <tr>
            <td>开始时间</td>
