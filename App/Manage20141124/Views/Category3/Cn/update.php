...
<table width="500" border="1">
  ...
  <tr>
    <td>链接地址</td>
    <td><input type="text" name="category_3_url" id="category_3_url" value="<?php echo $a['category_3_url']?>" maxlength="50">
    <span id="msg_category_3_th" style="display: none">请输入链接地址</span></td>
  </tr>
		<tr>
			<td>开始时间</td>
