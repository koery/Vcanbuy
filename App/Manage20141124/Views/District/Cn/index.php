...
<form method="POST" action="index" name="myform">
	<div>
		...
		区县:<input type="text" name="district" id="district" value='<?php echo get_post_value('district')?>'>
	...
	<table  border="1">
	  ...
	  <tr>
			...
			<td><a href="update?id=<?php echo $a['district_id']?>">修改</a></td>
			<td><a href="delete?id=<?php echo $a['district_id']?>"
