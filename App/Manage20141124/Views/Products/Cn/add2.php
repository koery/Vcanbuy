...
<script src="<?php echo JS_MODULE_PATH ?>products.js" type="text/javascript"></script>
<form method="POST" action="add_save" name="myform" onsubmit="return verifyData2()">
    ...
    <table width="600" border="1">
        ...
        <tr>
            <td>标题(中文)：</td>
            <td><input name="title_cn" type="text" id="title" size="60" value="" /></td>
        </tr>
        <tr>
            <td>标题(泰文)：</td>
            <td><input name="title_th" type="text" id="title" size="60" value="" /></td>
        </tr>
        <tr>
            <td>一级类目：</td>
        ...
        <tr>
            <td>进货价：</td>
            <td><input name="sales_price" type="text" id="sales_price" size="60"/></td>
        </tr>
        <tr>
            <td>销售价：</td>
            <td><input name="purchase_price" type="text" id="purchase_price" size="60"/></td>
        </tr>
        <tr>
            <td>优惠价：</td>
            <td><input name="preferential_price" type="text" id="preferential_price" size="60"/></td>
        </tr>
        <tr>
            <td>开始时间</td>
...
<!--     <td>&nbsp;<select name="sales_template"> -->
        ...
        <tr>
            <td>商家名称：</td>
            <td><input name="shop" type="text" id="shop" size="60" value="" /></td>
        </tr>
...
<input name="shop_id" type="text" id="shop_id"  value="<?php echo $data['shop_id'] ?>" />
<input name="shop_url" type="text" id="shop_url"  value="<?php echo $data['shop_url'] ?>" />
