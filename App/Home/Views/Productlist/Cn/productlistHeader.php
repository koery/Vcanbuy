...
<title>毛衣-Vcanbuy</title>
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>ProductList/productList.css" type="text/css">
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>ProductList/productListHeader.css" type="text/css">
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>ProductList/productListFooter.css" type="text/css">
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>ProductList/productListSearch.css" type="text/css">


<script src="<?php echo APP_MODULE_JS_PATH?>ProductList/productList.js"></script>


<link rel="stylesheet" href="<?php echo APP_CSS_PUBLIC_PATH?>sideBar.css" type="text/css">
<script src="<?php echo APP_JS_PUBLIC_PATH?>jquery-1.8.3.min.js"></script>
<script src="<?php echo APP_MODULE_JS_PATH?>Index/index.js"></script>
<script src="<?php echo APP_MODULE_JS_PATH?>Index/banner1.js"></script>
<script src="<?php echo APP_MODULE_JS_PATH?>Index/header.js"></script>
<script src="<?php echo APP_JS_PUBLIC_PATH?>sideBar.js"></script>

<script src="<?php echo APP_JS_PUBLIC_PATH?>category.js"></script>
</head>
<body>
