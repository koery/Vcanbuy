...
<div class="content_warp clearfix">
 <div class="w980 clearfix" style="background:javascript:void(0);fff;margin-bottom:40px;">
    	<div class="nav_left">
        	<dl class="notice">
...
<div class="lightbox" style="display:none;"></div><!--弹出层的部分 -->
<div class="dialogLayer" style="display:none;">
    <div class="close_top"><a class="close" href="javascript:void(0);"></a></div>
    <div class="dialogContent">
        <p class="dialogText">你确定要取消本订单吗？</p>
        <div class="tab_btn">
        	<a href="javascript:void(0);" class="dialogBtn dialogBtn_left">确定</a><a href="javascript:void(0);" class="dialogBtn dialogBtn_right">取消</a>
        </div>
    </div>
</div><!--弹出层的部分 end-->  
