        	...
        	<dl class="notice">
              ...
              <div class="mu_nav">
                    ...
                    <ul class="mu_nav_con">
                      ...
                      <li class="active" id="sending">待收货</li>
	               ...
	               foreach($MyorderBaseInfo as $key=>$MyorderBaseInfoItem){
                       ...
                       <tr class="order_item">
                            ...
                            ?>
		                            ...
		                            <a href="javascript:void(0);" class="cancelMyOrder"  orderId=<?php echo $MyorderBaseInfoItem['order_id']?>>取消订单</a>
		                    <?php 
                            	}else if($MyorderBaseInfoItem['status']==40000){													
                            		
							?>						
							   <a href="javascript:void(0);" class="confirm_receipt"  orderId=<?php echo $MyorderBaseInfoItem['order_id']?>>确认收货</a>
							<?php 
                            	}
                            ?>
                            </td>
...
<div class="dialogLayer" style="display:none;">
    ...
    <div class="dialogContent">
        <p class="dialogText">请核实货物，避免钱财两空</p>
        <div class="tab_btn">
