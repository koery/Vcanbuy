...
<title>商品详情</title>
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>Proinfo/productInfo.css" type="text/css">
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>Proinfo/productInfoHeader.css" type="text/css">
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>Proinfo/productInfoFooter.css" type="text/css">
<link rel="stylesheet" href="<?php echo APP_MODULE_CSS_PATH?>Proinfo/productInfoSearch.css" type="text/css">
<script src="<?php echo APP_JS_PUBLIC_PATH?>jquery-1.8.3.min.js"></script>
<script src="<?php echo APP_JS_PUBLIC_PATH?>search.js"></script>
<script src="<?php echo APP_MODULE_JS_PATH?>ProInfo/productInfo.js"></script>
