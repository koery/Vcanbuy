function addNewPersonRow(url,img){
 var bodyObj=document.getElementById("fm2_table_body_detail");  
 bodyObj.style.display = '';
    ...
    firstCell.innerHTML = "<img src='"+url +img+"' height='200' /><input type='hidden' name='detailfilename[]' value='"+img+"' />";
