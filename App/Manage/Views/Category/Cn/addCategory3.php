...
<form method="POST" action="add_saveCategory3" name="myform" onsubmit="return verifyData()">
...
<table width="500" border="1">
   ...
   <tr>
    <td width="147">二级类目：</td>
    <td width="337">
	<select name="category_2_id" id="category_2_id" onchange="setOrders()">
	 	<option value=""></option>
	 	<?php
	 	//print_r($category1Date);
	 	foreach ($category2Date as $a) {
			
				echo '<option value="'.$a['category_2_id'].'">'.$a['category_2_cn'].'</option>';
			
	 	} 
	 	?>
	 </select><span id="msg_category_2_id" style="display: none">请输入一级类目</span>
    </td>
  </tr>
  
  <tr>
    <td>三级类目(中文)</td>
    <td><input type="text" name="category_3_cn" id="category_3_cn" value="" maxlength="50">
    <span id="msg_category_3_cn" style="display: none">请输入二级类目(中文)</span></td>
  </tr>
  <tr>
    <td>三级类目(泰文)</td>
    <td><input type="text" name="category_3_th" id="category_3_th" value="" maxlength="50">
    <span id="msg_category_3_th" style="display: none">请输入二级类目(泰文)</span></td>
  </tr>
  
   <tr>
    <td>三级类目URL</td>
    <td><input type="text" name="category_3_url" id="category_3_url" value="" maxlength="50">
    <span id="msg_category_3_url" style="display: none">请输入二级类目URL</span></td>
  </tr>
