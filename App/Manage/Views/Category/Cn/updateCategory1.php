...
<?php $a = $category1Date[0];?>
<div class="container clearfix">
    
   
    <div class="main-wrap">
      <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="../category/category1">一级目录列表</a><span class="crumb-step">&gt;</span><span>一级目录修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="update_saveCategory1" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
							  ...
							  <tr>
							   <th><i class="require-red">*</i>一级目录URL：</th>
							    <td>
							         <input class="common-text required" id="category_1_url" name="category_1_url" size="50" value="<?php echo $a['category_1_url']?>" type="text">
							   </td>
							  </tr>
							  <tr>
