...
<?php $a = $category3Date[0];?>
<div class="container clearfix">
    
   
    <div class="main-wrap">
      <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="../category/category3">三级目录列表</a><span class="crumb-step">&gt;</span><span>三级目录修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="update_saveCategory3" method="post" id="myform" name="myform" enctype="multipart/form-data">
