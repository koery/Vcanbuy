...
<div class="container clearfix">   
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">活动列表</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="../activity/add"><i class="icon-font"></i>新增活动</a>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php foreach ( $activity as $a ) {?>
                         <tr>
			              ...
			              <td><?php 
							$str = '<a href="audit?id='.$a['activity_id'].'&status='.$a['status'].'" >';
							if ($a['status'] =='10000'){
								echo $str.'审核</a>';
						 ...
						 ?></td>                                              
						  <td><a href="update?id=<?php echo $a['activity_id']?>" >修改</a></td>
						  <td><a href="delete?id=<?php echo $a['activity_id']?>" onclick="return confirm('您确定删除吗？')">删除</a></td>
                        </tr>
