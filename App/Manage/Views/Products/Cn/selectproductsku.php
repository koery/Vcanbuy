      ...
      <div class="crumb-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="addproductskuitemnew" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
					      <?php 
					   
					   	foreach ($productskudata as $key=>$data){
					   	?>	
					      <tr>
					      <th width="120">
					      <?php echo $data['name']?>
					      ...
					      <td>
					      <input type="checkbox" name="name[]" value="<?php echo $data['property']?>"> 
					      </input>
					      </td>
					      </tr>
