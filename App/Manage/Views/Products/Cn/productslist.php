...
<div class="container clearfix">   
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">产品列表</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="../products/addproduct"><i class="icon-font"></i>新增产品</a>
					   ...
					   <?php foreach ( $productslist as $a ) {?>
						  <tr>
							  <td class="tc"><input name="id[]" value="59" type="checkbox"></td>
								...
								<td><?php echo $a['product_url']?></td>
							    <td><img src="<?php echo $a['img_path']?>" height="60" /> </td> 
								<td><?php echo $a['status_cn']; ?></td>	
								<td><?php 
									$str = '<a href="audit?id='.$a['product_id'].'&status='.$a['status'].'" >';
									if ($a['status'] =='10000'){
										echo $str.'审核</a>';
						  ...
						  <td><a href="productinfo?id=<?php echo $a['product_id']?> "  target="blank">详情</a></td>
                        </tr>
