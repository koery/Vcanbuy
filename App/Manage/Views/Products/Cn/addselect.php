...
<?php 
    	print_r($sku_code);
    	print_r($sku_name);
    	print_r(array_values($sku_code));
    	print_r(array_values($sku_name));
    	$sku_code=array_values($sku_code);
    	$sku_name=array_values($sku_name);
    	?>
      ...
      <div class="crumb-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="add_save_select_show" method="post" id="myform" name="myform" enctype="multipart/form-data">
