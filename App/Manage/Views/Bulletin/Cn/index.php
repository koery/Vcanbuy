...
<a href="add">创建</a>
	<table border="1" >
	  ...
	  <tr>
			...
			<td><?php 
				$str = '<a href="audit?bulletin_id='.$a['bulletin_id'].'&status='.$a['status'].'" >';
				if ($a['status'] =='10000'){
					echo $str.'审核</a>';
				}else if ($a['status'] =='30000'){
                $strQuit = '<a href="auditQuit?bulletin_id='.$a['bulletin_id'].'&status='.$a['status'].'" >';
					echo $strQuit.'取消审核</a>';
				}else{
					echo '-';
				}
			...
			<td><a href="update?bulletin_id=<?php echo $a['bulletin_id']?>" target="_blank">编辑</a></td>
	</tr>
	  <?php }?>
	</table>
