...
<div class="container clearfix">
    ...
    <div class="main-wrap">
      <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="../website/website">站点列表</a><span class="crumb-step">&gt;</span><span>新增站点</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="add_save" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>站点名称CH：</th>
                                <td>
                                    <input class="common-text required" id="website_name_cn" name="website_name_cn" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>站点名称TH：</th>
                                <td>
                                    <input class="common-text required" id="website_name_th" name="website_name_th" size="50" value="" type="text">
                                </td>
                            </tr>
  							<tr>
								<th><i class="require-red">*</i>站点URL：</th>
								 <td>
                                    <input class="common-text required" id="img_url" name="img_url" size="50" value="" type="text">
                                </td>
							</tr>
