...
<div class="container clearfix">   
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">首页广告列表</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="../banner/add_ads"><i class="icon-font"></i>新增广告</a>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php foreach ( $data as $a ) {?>
                         <tr>
			              ...
			              <td><?php 
							$str = '<a href="audit_ads?id='.$a['banner_id'].'&status='.$a['status'].'" >';
							if ($a['status'] =='10000'){
								echo $str.'审核</a>';
						 ...
						 ?></td>                                              
						  <td><a href="update_ads?id=<?php echo $a['banner_id']?>" >修改</a></td>
						  <td><a href="delete_ads?id=<?php echo $a['banner_id']?>" onclick="return confirm('您确定删除吗？')">删除</a></td>
                        </tr>
