...
<div class="container clearfix">
    ...
    <div class="main-wrap">
      <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="../banner/ads">首页广告列表</a><span class="crumb-step">&gt;</span><span>新增广告</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="add_save_ads" method="post" id="myform" name="myform" enctype="multipart/form-data">
