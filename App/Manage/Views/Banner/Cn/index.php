...
<div class="container clearfix">   
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../right/right">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">首页横幅列表</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="../banner/add"><i class="icon-font"></i>新增横幅</a>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php foreach ( $data as $a ) {?>
						 ...
						 ?></td>                                              
						  ...
						  <td><a href="delete?id=<?php echo $a['banner_id']?>" onclick="return confirm('您确定删除吗？')">删除</a></td>
                        </tr>
